    ...
    <div class="row layout1">
        <div class="layout2 col-md-6">
            <div class="layer text-center">
                <h2 class="title" data-aos="fade-down" data-aos-offset="200" data-aos-duration="800">Hubungi Kami</h2>
                <form data-aos="fade-up" data-aos-duration="800" action="" method="post">
                    <div class="form-group">
                        <input type="nama" class="form-control text" name="nama" placeholder="Nama" required>
                    </div>
                    <div class="form-group">
                        <input type="notelp" class="form-control text" name="noTelp" placeholder="Nomor Telepon" required>
                    </div>
                    <div class="form-group">
                        <textarea class="form-control text" name="pesan" rows="3" placeholder="Pesan" required></textarea>
                    </div>
        ...
        <div class="layout1 col-md-6 margin">
            <div class="layer text-center" data-aos="fade-down" data-aos-offset="200" data-aos-duration="800">
                <img src="./image/Contact Us.png" alt="Contact Us" style=" width:200px;" class="img">
            </div>
        </div>
    </div>
