    ...
    <div class="row layout1">
        <div class="layout2 col-md-6">
            <div class="layer text-center">
                <h2 class="title" data-aos="fade-down" data-aos-offset="200" data-aos-duration="800">Daftar</h2>
                <form data-aos="fade-up" data-aos-duration="800" action="" method="post">
                    ...
                    <div class="form-group row">
                        <label for="birthday" class="col-sm-3 col-form-label text" style="text-align: left;">Tanggal Lahir:</label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control text" id="birthday" name="tggLahir" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row text-left">
                          <legend class="col-form-label col-sm-3 pt-0 text">Jenis Kelamin:</legend>
                          <div class="col-sm-9">
                            <div class="form-check text">
                                <input class="form-check-input" type="radio" name="jnsKelamin" id="gridRadios1" value="Laki-Laki" required>
                                <label class="form-check-label jarak" for="gridRadios1">
                                    Laki-Laki
                                </label>
                            </div>
                            <div class="form-check text">
                                <input class="form-check-input" type="radio" name="jnsKelamin" id="gridRadios2" value="Perempuan" required>
                                <label class="form-check-label jarak" for="gridRadios2">
                                    Perempuan
                                </label>
                            </div>
                            <div class="form-check text">
                                <input class="form-check-input" type="radio" name="jnsKelamin" id="gridRadios3" value="Lainnya" required>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control text" name="noTelp" placeholder="Nomor Telepon" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control text" name="alamat" placeholder="Alamat" required>
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control text" name="password" placeholder="Password" required>
                    </div>
                    <button type="submit" name="submit" class="button">Daftar</button>
                </form>
            </div>
        </div>
        <div class="layout1 col-md-6 margin">
            <div class=" layer text-center">
                <h2 class="title" data-aos="fade-down" data-aos-offset="200" data-aos-duration="800">Sudah Punya Akun?</h2>
                <a title="Masuk" href="./Login.php">
                    <button class="signup" data-aos="fade-up" data-aos-duration="800">Masuk Sekarang</button>
                </a> 
            </div>
        </div>
    </div>
