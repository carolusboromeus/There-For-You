            ...
            <div class="container layer">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3 text-center margin" data-aos="fade-up" data-aos-duration="800">
                            <div class="frame">
                                ...
                                <div style="margin-top: 7px;">
                                    <input type="radio" class="btn-check btn-radio" name="topik" id="topik1" autocomplete="off" required>
                        ...
                        <div class="form-group col-md-3 text-center margin" data-aos="fade-up" data-aos-duration="800">
                            <div class="frame">
                                ...
                                <div style="margin-top: 7px;">
                                    <input type="radio" class="btn-check btn-radio" name="topik" id="topik2" autocomplete="off" required>
                        ...
                        <div class="form-group col-md-3 text-center margin" data-aos="fade-up" data-aos-duration="800">
                            <div class="frame">
                                ...
                                <div style="margin-top: 7px;">
                                    <input type="radio" class="btn-check btn-radio" name="topik" id="topik3" autocomplete="off" required>
                        ...
                        <div class="form-group col-md-3 text-center margin" data-aos="fade-up" data-aos-duration="800">
                            <div class="frame">
                                ...
                                <div style="margin-top: 7px;">
                                    <input type="radio" class="btn-check btn-radio" name="topik" id="topik4" autocomplete="off" required>
                ...
                <div class="collapse psikolog-page" id="myPsikolog">
                    ...
                    <div class="row psikolog-layer" data-aos="fade-up" data-aos-duration="800">
                        ...
                        <div class="col-5 margin text-right">
                            <input type="radio" class="btn-check btn-radio" name="psikolog" id="psikolog1" autocomplete="off" required>
                    ...
                    <div class="row psikolog-layer" data-aos="fade-up" data-aos-duration="800">
                        ...
                        <div class="col-5 margin text-right">
                            <input type="radio" class="btn-check btn-radio" name="psikolog" id="psikolog2" autocomplete="off" required>
                    ...
                    <div class="row psikolog-layer" data-aos="fade-up" data-aos-duration="800">
                        ...
                        <div class="col-5 margin text-right">
                            <input type="radio" class="btn-check btn-radio" name="psikolog" id="psikolog3" autocomplete="off" required>
                    ...
                    <div class="row psikolog-layer" data-aos="fade-up" data-aos-duration="800">
                        ...
                        <div class="col-5 margin text-right">
                            <input type="radio" class="btn-check btn-radio" name="psikolog" id="psikolog4" autocomplete="off" required>
                ...
                <div class="collapse jadwal-page" id="myJadwal">
                    ...
                    <div class="text-center">
                        ...
                        <a href="./Login.php" class="btn button" style="color: white;">
