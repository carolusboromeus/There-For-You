            ...
            <div class="row">
                ...
                <div class="col-md-6 d-none d-sm-none d-md-block margin text" data-aos="fade-left" data-aos-duration="800" style="text-align: justify;">
                    ...
                    <p>
                        ...
                        <br><br>
                        🗓️ : Sabtu, 4 Desember 2021<br>
                        ⏰ : 13.00 WIB - Selesai<br>
                        💻 : Via Zoom
                        <br><br>
                        Dengan Pembicara:<br>
                        👉🏻Retno Utari Kusumaningrum, M.Psi., Psikolog (Psikolog Klinis) @retnoutarii
                    </p>
                </div>
    ...
    <div class="layout1">
        <div class="container layer">
            <div class="margin text" data-aos="fade-up" data-aos-duration="800" style="text-align: justify;">
                <p>
                    Yukk, bagi teman-teman yang tertarik untuk bergabung dan menambah pengalaman serta ilmu yang bermanfaat.
                    <br><br>
                    Kami tunggu kehadirannya yaa, terima kasih☺
                </p>
            </div>
        </div>
    </div>
